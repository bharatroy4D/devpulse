import { pool } from "../../db";
const createIssuesIntoDB = async (payload, reporterId) => {
...
const getSingleIssuesIntoDB = async (id) => {
    const result = await pool.query(`
...
const getAllIssuesIntoDB = async (sort, type, status) => {
};
const updateIssuesIntoDB = async (issuesId, payload, user) => {
...
const deleteIssuesIntoDB = async (id) => {
    const result = await pool.query(`
